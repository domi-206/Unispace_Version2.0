...
import { MessageSquare, Heart, Share2, PenSquare, Trophy, Image as ImageIcon, X } from 'lucide-react';
            ...
            <div className="flex space-x-4">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-700 rounded-xl p-3 text-sm focus:ring-2 focus:ring-green-500 outline-none resize-none border border-transparent focus:bg-white dark:focus:bg-slate-900 transition-all dark:text-white"
                  rows={3}
                />
